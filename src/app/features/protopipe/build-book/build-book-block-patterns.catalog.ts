...
export const BUILD_BOOK_BLOCK_PATTERNS: BuildBookBlockPattern[] = [
  ...
  { id: 'quick-answer', label: 'Quick answer', category: 'content', intents: ['answer-questions', 'explain-offer'], interactive: false, sortOrder: 171 },
  { id: 'comparison-table', label: 'Comparison table', category: 'content', intents: ['qualify-lead', 'prove-outcomes'], interactive: false, sortOrder: 171.5 },
  { id: 'case-snapshot', label: 'Case snapshot', category: 'content', intents: ['prove-outcomes', 'establish-trust'], interactive: false, sortOrder: 171.7 },
  { id: 'related-links', label: 'Related links', category: 'content', intents: ['answer-questions', 'close-conversion'], interactive: false, sortOrder: 171.9 },
  { id: 'blog-masthead', label: 'Blog masthead', category: 'content', intents: ['explain-offer'], interactive: false, sortOrder: 172 },
  { id: 'blog-featured', label: 'Featured post', category: 'content', intents: ['show-work'], interactive: false, sortOrder: 174 },
  { id: 'blog-magazine-split', label: 'Magazine split', category: 'content', intents: ['show-work'], interactive: false, sortOrder: 176 },
  { id: 'blog-post-grid', label: 'Post grid / list', category: 'content', intents: ['show-work'], interactive: false, sortOrder: 178 },
  { id: 'blog-topic-bar', label: 'Topic bar', category: 'content', intents: ['answer-questions'], interactive: false, sortOrder: 179 },
