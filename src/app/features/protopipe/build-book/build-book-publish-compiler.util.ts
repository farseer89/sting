...
export const UNIVERSAL_PUBLISH_VARIANT_BY_COMPONENT_ID: Record<string, string> = {
  ...
  'universal-prose-band': 'prose',
  'universal-quick-answer': 'quick-answer',
  'universal-comparison-table': 'comparison',
  'universal-case-snapshot': 'snapshot',
  'universal-related-links': 'related-links',
