...
export const BUILD_BOOK_PATTERN_CONTRACTS: Record<string, BuildBookPatternContract> = {
  ...
  'blog-masthead': { requiredCopyPaths: ['title', 'subhead'] },
  'blog-featured': { requiredCopyPaths: ['kicker'] },
  'blog-magazine-split': { requiredCopyPaths: ['kicker'] },
  'blog-post-grid': { requiredCopyPaths: ['heading'] },
  'blog-topic-bar': { requiredCopyPaths: ['topics'] },
