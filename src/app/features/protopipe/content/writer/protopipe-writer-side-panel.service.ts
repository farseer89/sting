...
const OPEN_KEY = 'protopipe.writer.sidePanelOpen';
const WIDTH_KEY = 'protopipe.writer.sidePanelWidthPct';
const WIDTH_DEFAULT = 32;
const WIDTH_MIN = 22;
const WIDTH_MAX = 48;
const RAIL_WIDTH_PX = 48;

/** Standalone writer route — resizable right inspector slider. */
@Injectable()
export class ProtopipeWriterSidePanelService {
